...
Olvídate de formularios: escribe natural y listo.
...
- Maneja todas tus monedas: **CUP, USD, USDT y más**.
...
- **"¿Cuánto tengo?"** → balance completo (ingresos, gastos y neto por moneda).
...
- **Resumen del mes** → lo que pasó en tu dinero este mes, de un vistazo.
...
- **Crea metas**: *"quiero ahorrar 2000 para vacaciones"*.
