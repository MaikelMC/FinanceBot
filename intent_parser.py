...
- Para "configurar_presupuesto": el campo "nombre" es el nombre del presupuesto (puede diferir de la categoría). Si el usuario da una etiqueta propia (ej: "mi presupuesto para salidas con amigos es 300"), usa nombre: "salidas con amigos". Si no, usa nombre igual a la categoría. IMPORTANTE: si el usuario describe el presupuesto con sus propias palabras tras el monto (ej: "tengo un presupuesto de 1000 cup para barbería"), copia esa etiqueta textual en "nombre" (ej: "barbería"), aunque la categoría sea "otros".
